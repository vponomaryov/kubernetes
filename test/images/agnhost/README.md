...
```yaml
    ...
    spec:
      ...
      - args:
        - dns-suffix
        image: us.gcr.io/k8s-artifacts-prod/e2e-test-images/agnhost:2.22
        name: agnhost
      dnsConfig:
        nameservers:
        - 1.1.1.1
...
sed_expr="s|{{.AgnhostImage}}|us.gcr.io/k8s-artifacts-prod/e2e-test-images/agnhost:2.22|"
...
```console
docker run -i \
  us.gcr.io/k8s-artifacts-prod/e2e-test-images/agnhost:2.22 \
...
The image can be found at `us.gcr.io/k8s-artifacts-prod/e2e-test-images/agnhost:2.22` for both Linux and
